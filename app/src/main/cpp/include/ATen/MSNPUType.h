...
struct CAFFE2_API MSNPUTypeDispatch {
...
struct CAFFE2_API MSNPUType : public TypeDefault {
  explicit MSNPUType();
  ...
  Tensor contiguous(const Tensor & self, MemoryFormat memory_format) const override;
  ...
  Tensor _copy_from(const Tensor & self, const Tensor & dst, bool non_blocking) const override;
  ...
  Tensor poisson_nll_loss(const Tensor & input, const Tensor & target, bool log_input, bool full, double eps, int64_t reduction) const override;
  ...
  std::tuple<Tensor,Tensor> std_mean(const Tensor & self, bool unbiased) const override;
  std::tuple<Tensor,Tensor> std_mean(const Tensor & self, IntArrayRef dim, bool unbiased, bool keepdim) const override;
  ...
  std::tuple<Tensor,Tensor> var_mean(const Tensor & self, bool unbiased) const override;
  std::tuple<Tensor,Tensor> var_mean(const Tensor & self, IntArrayRef dim, bool unbiased, bool keepdim) const override;

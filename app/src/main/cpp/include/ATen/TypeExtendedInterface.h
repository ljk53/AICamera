...
struct CAFFE2_API TypeExtendedInterface : public Type {
  ...
  virtual Tensor & _th_masked_fill_bool_(Tensor & self, const Tensor & mask, Scalar value) const = 0;
  virtual Tensor & _th_masked_fill_bool_(Tensor & self, const Tensor & mask, const Tensor & value) const = 0;
  ...
  virtual Tensor & _th_masked_scatter_bool_(Tensor & self, const Tensor & mask, const Tensor & source) const = 0;
  ...
  virtual Tensor & _th_masked_select_bool_out(Tensor & result, const Tensor & self, const Tensor & mask) const = 0;
  virtual Tensor _th_masked_select_bool(const Tensor & self, const Tensor & mask) const = 0;

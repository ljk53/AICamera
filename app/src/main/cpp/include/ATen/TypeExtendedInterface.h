...
struct CAFFE2_API TypeExtendedInterface : public Type {
  ...
  virtual Tensor _copy_from(const Tensor & self, const Tensor & dst, bool non_blocking) const = 0;
  ...
  virtual Tensor poisson_nll_loss(const Tensor & input, const Tensor & target, bool log_input, bool full, double eps, int64_t reduction) const = 0;
  ...
  virtual Tensor & _index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const = 0;
  virtual Tensor _cumsum(const Tensor & self, int64_t dim) const = 0;
  virtual Tensor & _cumsum_out(Tensor & out, const Tensor & self, int64_t dim) const = 0;
  virtual Tensor _cumprod(const Tensor & self, int64_t dim) const = 0;
  virtual Tensor & _cumprod_out(Tensor & out, const Tensor & self, int64_t dim) const = 0;
  virtual Tensor _var(const Tensor & self, bool unbiased) const = 0;
  virtual Tensor _std(const Tensor & self, bool unbiased) const = 0;
  virtual Tensor & _addmm_out(Tensor & out, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const = 0;
  virtual Tensor _addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const = 0;
  virtual Tensor & _addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const = 0;
  virtual Tensor _cat(TensorList tensors, int64_t dim) const = 0;
  virtual Tensor & _cat_out(Tensor & out, TensorList tensors, int64_t dim) const = 0;
  virtual std::tuple<Tensor,Tensor> _mode(const Tensor & self, int64_t dim, bool keepdim) const = 0;
  virtual std::tuple<Tensor &,Tensor &> _mode_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim) const = 0;
  virtual std::tuple<Tensor,Tensor> _max(const Tensor & self, int64_t dim, bool keepdim) const = 0;
  virtual std::tuple<Tensor &,Tensor &> _max_out(Tensor & max, Tensor & max_indices, const Tensor & self, int64_t dim, bool keepdim) const = 0;
  virtual std::tuple<Tensor,Tensor> _min(const Tensor & self, int64_t dim, bool keepdim) const = 0;
  virtual std::tuple<Tensor &,Tensor &> _min_out(Tensor & min, Tensor & min_indices, const Tensor & self, int64_t dim, bool keepdim) const = 0;
  ...
  virtual Tensor mkldnn_adaptive_avg_pool2d(const Tensor & self, IntArrayRef output_size) const = 0;
  ...
  virtual std::tuple<Tensor &,Tensor &> max_pool2d_with_indices_out(Tensor & out, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool ceil_mode) const = 0;

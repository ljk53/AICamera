...
CAFFE2_API Tensor & _s_copy__quantized(Tensor & self, const Tensor & src, bool non_blocking=false);
...
CAFFE2_API Tensor & cumsum_out(Tensor & out, const Tensor & self, int64_t dim, ScalarType dtype);
CAFFE2_API Tensor & cumsum_out(Tensor & out, const Tensor & self, int64_t dim);
...
CAFFE2_API Tensor & cumprod_out(Tensor & out, const Tensor & self, int64_t dim, ScalarType dtype);
CAFFE2_API Tensor & cumprod_out(Tensor & out, const Tensor & self, int64_t dim);
...
CAFFE2_API Tensor empty_affine_quantized_cpu(IntArrayRef size, const TensorOptions & options={}, double scale=1, int64_t zero_point=0);
CAFFE2_API Tensor & resize_cpu_(Tensor & self, IntArrayRef size);
CAFFE2_API Tensor & resize_cuda_(Tensor & self, IntArrayRef size);
CAFFE2_API Tensor & empty_out(Tensor & out, IntArrayRef size);
...
CAFFE2_API Tensor & mean_out(Tensor & out, const Tensor & self, IntArrayRef dim, bool keepdim, ScalarType dtype);
CAFFE2_API Tensor & mean_out(Tensor & out, const Tensor & self, IntArrayRef dim, bool keepdim=false);
CAFFE2_API Tensor & mean_out(Tensor & out, const Tensor & self, IntArrayRef dim, ScalarType dtype);
...
CAFFE2_API Tensor & _neg__cpu(Tensor & self);
CAFFE2_API Tensor & _neg__cuda(Tensor & self);
CAFFE2_API Tensor & _neg_out_cpu(Tensor & out, const Tensor & self);
CAFFE2_API Tensor & _neg_out_cuda(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & add_out_dense_sparse_cpu(Tensor & out, const Tensor & self, SparseTensorRef other, Scalar alpha=1);
CAFFE2_API Tensor & add_out_dense_sparse_cuda(Tensor & out, const Tensor & self, SparseTensorRef other, Scalar alpha=1);
...
CAFFE2_API Tensor & prod_out(Tensor & out, const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype);
CAFFE2_API Tensor & prod_out(Tensor & out, const Tensor & self, int64_t dim, bool keepdim=false);
CAFFE2_API Tensor & prod_out(Tensor & out, const Tensor & self, int64_t dim, ScalarType dtype);
...
CAFFE2_API Tensor quantize_linear_cpu(const Tensor & self, double scale, int64_t zero_point);
CAFFE2_API Tensor dequantize_quant(const Tensor & self);
CAFFE2_API Scalar q_scale_quant(const Tensor & self);
CAFFE2_API Scalar q_zero_point_quant(const Tensor & self);
...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> quantized_lstm(const Tensor & input, TensorList hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first);
...
CAFFE2_API std::tuple<Tensor &,Tensor &> pstrf_out(Tensor & u, Tensor & pivot, const Tensor & self, bool upper=true, Scalar tol=-1);
...
CAFFE2_API Tensor _multinomial_alias_draw(const Tensor & J, const Tensor & q, int64_t num_samples, Generator * generator=nullptr);
...
CAFFE2_API Tensor & _histc_out_cpu(Tensor & out, const Tensor & self, int64_t bins=100, Scalar min=0, Scalar max=0);
CAFFE2_API Tensor & _histc_out_cuda(Tensor & out, const Tensor & self, int64_t bins=100, Scalar min=0, Scalar max=0);
CAFFE2_API Tensor _histc_cpu(const Tensor & self, int64_t bins=100, Scalar min=0, Scalar max=0);
...
CAFFE2_API Tensor & mkldnn_avg_pool2d_out(Tensor & out, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, bool ceil_mode=false, bool count_include_pad=true);
...
CAFFE2_API Tensor mkldnn_avg_pool2d(const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, bool ceil_mode=false, bool count_include_pad=true);
...
CAFFE2_API std::tuple<Tensor &,Tensor &> max_pool2d_with_indices_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, IntArrayRef dilation=1, bool ceil_mode=false);
...
CAFFE2_API std::tuple<Tensor &,Tensor &> max_pool3d_with_indices_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride={}, IntArrayRef padding=0, IntArrayRef dilation=1, bool ceil_mode=false);
...
CAFFE2_API std::tuple<Tensor &,Tensor &,Tensor &> thnn_conv_dilated3d_backward_out(Tensor & grad_input, Tensor & grad_weight, Tensor & grad_bias, const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, const Tensor & columns, const Tensor & ones);
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> thnn_conv_dilated3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, const Tensor & columns, const Tensor & ones, std::array<bool,3> output_mask);
CAFFE2_API Tensor thnn_col2im(const Tensor & self, IntArrayRef output_size, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride);
CAFFE2_API Tensor thnn_col2im_backward(const Tensor & grad_output, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride);
CAFFE2_API Tensor thnn_im2col(const Tensor & self, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride);
CAFFE2_API Tensor thnn_im2col_backward(const Tensor & grad_output, IntArrayRef input_size, IntArrayRef kernel_size, IntArrayRef dilation, IntArrayRef padding, IntArrayRef stride);

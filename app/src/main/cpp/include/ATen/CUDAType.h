...
struct CUDAType final : public CUDATypeDefault {
  ...
  Tensor & _th_masked_fill_bool_(Tensor & self, const Tensor & mask, Scalar value) const override;
  Tensor & _th_masked_fill_bool_(Tensor & self, const Tensor & mask, const Tensor & value) const override;
  Tensor & s__th_masked_scatter_(Tensor & self, const Tensor & mask, const Tensor & source) const override;
  Tensor & _th_masked_scatter_bool_(Tensor & self, const Tensor & mask, const Tensor & source) const override;
  ...
  Tensor & _th_masked_select_bool_out(Tensor & result, const Tensor & self, const Tensor & mask) const override;
  Tensor _th_masked_select_bool(const Tensor & self, const Tensor & mask) const override;
